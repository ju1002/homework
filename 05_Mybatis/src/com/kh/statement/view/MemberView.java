...
public class MemberView {
	...
	public void findAll() {
		...
		System.out.println("조회된 총 회원수"+members.size()+"명입니다.");
		if(members.isEmpty()) {
			...
			for(Member member : members) {
				...
				System.out.print("이메일 :"+member.getEmamil()+",");
	...
	public void update() {
		...
		//아이디랑 비밀번호가 있는거 있으면 새비밀번호 바꾸기
		System.out.println("아이디를 입력해 주세요");
		String userId = sc.nextLine();
		System.out.println("비밀번호를 입력해주세요");
		String userPwd =sc.nextLine();
		System.out.println("새비밀번호를 입력해주세요");
